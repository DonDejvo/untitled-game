...
public class Level extends Component {
    ...
    private void createEntities() {
        ...
        for (Entity entity : entities) {
            ...
            switch (entity.getName()) {
                case "player": {
                    player = go;
                    BoxCollider3D collider = new BoxCollider3D(new Vector3d(1.5, 7, 1.5));
                ...
                case "vending_machine": {
                    BoxCollider3D collider = new BoxCollider3D(new Vector3d(2, 8, 2));
                    go.addComponent("Collider", collider);
                    DialogComponent dialogComponent = new DialogComponent(getComponent(DialogManager.class, "DialogManager"));
    ...
    */
    private void initEnemy(GameObject go, PathFinder pathFinder, SpriteRenderer renderer, String name) {
        ...
        switch (name) {
            case "goblin": {
                collider = new BoxCollider3D(new Vector3d(1.5, 7, 1.5));
    ...
    */
    private void createDoors() {
        ...
        for (Door door : doors) {
            ...
            doorGameObject.transform.scale.set(Level.TILE_SIZE, Level.TILE_SIZE * 2, Level.TILE_SIZE * 0.125);
            BoxCollider3D collider = new BoxCollider3D(new Vector3d(4, 8, 4));
